var MidiPiano=MidiPiano||{};!function(e,a){"use strict";function t(){for(var e=0;e<7;++e){var a=12*e;o(a+0,"W","B"),o(a+1,"B","W"),o(a+2,"W","B"),o(a+3,"W","W"),o(a+4,"B","W"),o(a+5,"W","B"),o(a+6,"B","W"),o(a+7,"W","B"),o(a+8,"W","W"),o(a+9,"B","W"),o(a+10,"W","B"),o(a+11,"B","W")}o(84,"W","B"),o(85,"B","W"),o(86,"W","B"),o(87,"W","W"),MIDI.Player.addListener(function(e){var a=(e.channel,e.velocity),t=(e.message,e.note-21);144==e.message?0==a?"B"==H[t]?R[t].material.color=b:R[t].material.color=P:R[t].material.color=_:"B"==H[t]?R[t].material.color=b:R[t].material.color=P,R[t].material.needsUpdate=!0}),UltimateLoader.load("assets/model/piano.obj",function(a){E=a,E.scale.set(F,F,F),z.add(E),z.position.set(f.x,f.y,f.z),z.rotation.x=f.x*(Math.PI/180),z.rotation.y=f.y*(Math.PI/180),z.rotation.z=f.z*(Math.PI/180),M.add(z);var t=n("Play me!",0,125,67,-18,50);E.add(t);var o=n("MIDI Keyboard?",0,118,69,-18,50);E.add(o);var r=n("Visit - norybiak.com/apps/piano -",0,114,70,-18,50);E.add(r);var l=new THREE.MTLLoader.MaterialCreator;l.crossOrigin="anonymous";var d="assets/textures/wood.jpg",c=l.loadTexture(d),u=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:c}),p=new THREE.BoxGeometry(7,5,30),h=new THREE.Mesh(p,u);h.scale.set(1,1,1),h.position.set(-75.9,79.5,83),E.add(h);var m=new THREE.Mesh(p,u);for(m.scale.set(1,1,1),m.position.set(77.3,79.5,83),E.add(m),i(),e=0;e<Y.length;e++)Y[e].text=n(Y[e].title,0,100,80.5,0,50),E.add(Y[e].text),Y[e].text.visible=!1;animate(),s(),console.log("Piano initalized!")})}function o(e,a,t){if("W"==a){D+="W"==t?S:k;var o=new THREE.BoxGeometry(2.68,5.83,17.5);o.translate(0,0,8.75);var i=new THREE.MTLLoader.MaterialCreator;i.crossOrigin="anonymous";var n="assets/textures/keyShadow.png",r=i.loadTexture(n),s=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:r});R[e]=new THREE.Mesh(o,s),R[e].scale.set(F,F,F),R[e].position.set(D,W,C)}else if("B"==a){D+=k;var o=new THREE.BoxGeometry(1.52,6.07,12.83),s=new THREE.MeshBasicMaterial({color:"#000000"});o.translate(0,0,6.415),R[e]=new THREE.Mesh(o,s),R[e].scale.set(F,F,F),R[e].position.set(D,W+N,C)}H[e]=a,R[e].addBehavior(altspace.utilities.behaviors.JointCollisionEvents({joints:[["Index","Right",3],["Index","Left",3]],jointCubeSize:.1})),R[e].addEventListener("jointcollisionenter",function(a){U||(l(e+21,127),T.child(w).child("notes").child(e+21).set([Math.random(),127]),setTimeout(function(){d(e+21,0),T.child(w).child("notes").child(e+21).set([0,127])},300))}),R[e].addEventListener("cursordown",function(){U||(l(e+21,127),T.child(w).child("notes").child(e+21).set([Math.random(),127]),setTimeout(function(){d(e+21,0),T.child(w).child("notes").child(e+21).set([0,127])},300))}),z.add(R[e])}function i(){var e,a=new THREE.MTLLoader.MaterialCreator;a.crossOrigin="anonymous";var t="assets/textures/buttonShadow.png",o=a.loadTexture(t);e=new THREE.BoxGeometry(3,3,3);var i=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#00ff00",map:o}));i.scale.set(1,1,1),i.position.set(0,5,0),A.add(i),i.addEventListener("cursordown",function(e){MIDI.Player.playing||(g.update({startTime:Firebase.ServerValue.TIMESTAMP}),g.update({userStarted:w}),g.update({playing:1}))});var r=n("Play",5,-1.5,.5,0,25);r.x=5,i.add(r),e=new THREE.BoxGeometry(3,3,3);var s=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#f0ff00",map:o}));s.scale.set(1,1,1),s.position.set(0,0,0),A.add(s),s.addEventListener("cursorup",function(e){J++,g.update({playing:0,song:J})});var l=n("Next",5,-1.5,.5,0,25);s.add(l),e=new THREE.BoxGeometry(3,3,3);var d=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#FF0000",map:o}));d.scale.set(1,1,1),d.position.set(0,-5,0),A.add(d),d.addEventListener("cursorup",function(e){g.update({playing:0})});var u=n("Stop",5,-1.5,.5,0,25);d.add(u),A.position.set(-66,95,80),E.add(A),e=new THREE.BoxGeometry(3,3,3);var p=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#f0ff00",map:o}));p.scale.set(1,1,1),p.position.set(-70,0,0),L.add(p);var h=n("Mute",0,3,.5,0,25),m=n("Unmute",0,3,.5,0,25);m.visible=!1,p.add(h),p.add(m),p.addEventListener("cursorup",function(e){h.visible=!h.visible,m.visible=!m.visible,U=!U,c(U?0:j)}),e=new THREE.BoxGeometry(10,1,0);var f=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#9f9f9f",map:o}));f.scale.set(1,1,1),f.position.set(-55,-1,0),f.visible=!1,L.add(f);var v=n("Vol",0,-4.5,.5,0,25);f.add(v);for(var M=0;M<5;M++)e=new THREE.BoxGeometry(.8,M+1,2),G[M]=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#f0ff00",map:o})),G[M].scale.set(2,2,2),G[M].position.set(-4.2+2*M,-.5+(M+1),-.5),f.add(G[M]),G[M].addEventListener("cursorup",function(e){for(var a=!1,t=0;t<5;t++)e.target==G[t]?(G[t].material.color=K,j=t+1,c(j),a=!0):a?G[t].material.color=O:G[t].material.color=K});L.position.set(120,95,80),L.scale.set(1,1,1),E.add(L)}function n(e,a,t,o,i,n){var r={text:e,fontSize:n},s=u(r);return s.position.set(a,t,o+1),s.rotateX(i*Math.PI/180),s}function r(e,a){e.visible=a}function s(){function e(){a.on("value",function(e){var a=e.val();1==a?(T.child(w).child("control").update({joinTime:Firebase.ServerValue.TIMESTAMP}),g.child("startTime").once("value",function(e){var a=e.val();T.child(w).child("control").child("joinTime").once("value",function(e){var t=e.val(),o=t-a;o>MIDI.Player.endTime?g.update({playing:0}):(MIDI.Player.currentTime=o,MIDI.Player.start())})})):(MIDI.Player.stop(),g.update({startTime:0}))})}g.once("value",function(e){var a=e.exists();a||g.set({playing:0,song:0})}),T.child(w).child("settings").set({color:y}),T.on("child_added",function(e,a){var t=e.key(),o=T.child(t);t!=w&&(console.log("New user joined: "+t),o.child("settings").child("color").once("value",function(e){var a=e.val();a||(a=Please.make_color({golden:!1,saturation:1,value:1})[0]),V[t]=new THREE.Color(a),console.log("User "+t+"'s color is set to "+e.val())}),o.child("notes").on("child_added",function(e){var a=e.key();e.val();o.child("notes").child(a).on("value",function(e){var o=e.val();if(o){var i=o[0],n=o[1];0==i?d(a,n):l(a,n,t)}})}))}),T.child(w).onDisconnect().remove(),T.on("child_removed",function(e){var a=e.key(),t=T.child(a);t.child("on").off("value"),t.child("off").off("value"),delete V[a],console.log("User "+e.key()+" has left.")});var a=g.child("playing"),t=g.child("song");g.child("currentTime");t.on("value",function(a){var t=a.val();J=t>Y.length-1?0:t,X?(MIDI.Player.timeWarp=Y[J].speed,MIDI.Player.loadFile("assets/songs/"+Y[J].file,function(){console.log(Y[J].title+"  loaded!"),e(),X=!1})):(MIDI.Player.timeWarp=Y[J].speed,MIDI.Player.loadFile("assets/songs/"+Y[J].file,function(){console.log(Y[J].title+"  loaded!")})),r(Y[t-1].text,!1),r(Y[J].text,!0),console.log("current song:"+J)}),console.log("Firebase functions initalized!")}function l(e,a,t){if(t=t||!1,U||MIDI.noteOn(0,e,a),0==R[e-21].rotation.x)if("B"==H[e-21]){new TWEEN.Tween(R[e-21].rotation).to({x:R[e-21].rotation.x+.02*Math.PI},.1).start()}else{new TWEEN.Tween(R[e-21].rotation).to({x:R[e-21].rotation.x+.04*Math.PI},.1).start()}t?R[e-21].material.color=V[t]:R[e-21].material.color=I}function d(e,a,t){U||MIDI.noteOff(0,e,a);new TWEEN.Tween(R[e-21].rotation).to({x:0},.1).start();"B"==H[e-21]?R[e-21].material.color=b:R[e-21].material.color=P}function c(e){var a=25.4*e;MIDI.setVolume(0,a),console.log(e+" "+a)}function u(e){var a=p("n-text");return h(a,"n-text",e),a}function p(e){var a=new THREE.BoxGeometry(.001,.001,.001),t=new THREE.MeshBasicMaterial({color:0});t.visible=!1;var o=new THREE.Mesh(a,t);return M.add(o),altspace.addNativeComponent(o,e),o}function h(e,a,t){var o=Z["n-text"];for(var i in t)o[i]=t[i];altspace.updateNativeComponent(e,a,o)}var m,E,f,v,M,g,T,w,y,I,R=[],H=[],x="",B="",_=new THREE.Color(16711680),P=new THREE.Color(16777215),b=new THREE.Color(0),D=-217,W=-270,C=240,F=3,S=8.5,k=4.2,N=3,z=new THREE.Group,G=[],L=new THREE.Group,A=new THREE.Group,U=!1,j=5,O=new THREE.Color(10461087),K=new THREE.Color(15793920),V={},J=0,X=!0,Y=[{file:"mozart_sonata_2-pianos_375_1_(c)ishenko.mid",title:"Sonata in D major, for two - Mozart",speed:1},{file:"517-Scarlatti.mid",title:"Sonata in D minor, K. 517 - Scarlatti",speed:.5},{file:"HungarianRhapsodyNo10S24410.mid",title:"Hungarian Rhapsody No. 10, S. 244/10",speed:1},{file:"Roslin_Adama.mid",title:"Roslin & Adama - Bear McCreary",speed:1},{file:"ParagonX9_Chaoz_Fantasy.mid",title:"Chaoz Fantasy - ParagonX9",speed:1},{file:"swordland_1.mid",title:"Swordland (SAO) - Yuki Kajiura",speed:1},{file:"9725s_maple_leaf_rag_(nc)smythe.mid",title:"Maple Leaf - Scott Joplin",speed:1},{file:"hes_a_pirate.mid",title:"He's a Pirate - Klaus Badelt",speed:1},{file:"touhou.mid",title:"U.N. Owen Was Her? - ZUN",speed:1},{file:"cruel_angel.mid",title:"Cruel Angel - Neko Oikawa",speed:1},{file:"tchaikovsky_nutcracker_act-1_2_march_(c)yogore.mid",title:"March (Nutcracker) - Tchaikovsky",speed:1},{file:"Hotline_Bling_MIDI_UPDATED_2016.mid",title:"Hotline Bling",speed:1}],Z={"n-text":{text:"",fontSize:10,width:80,height:1,horizontalAlign:"middle",verticalAlign:"middle"}};e.start=function(e,o){return M=e||!1,f=o.position||{x:0,y:0,z:0},v=o.rotation||{x:0,y:0,z:0},M?void MIDI.loadPlugin({soundfontUrl:"assets/soundfont/",targetFormat:"ogg",instruments:"acoustic_grand_piano",onsuccess:function(){if(MIDI.programChange(4,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(3,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(2,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(1,MIDI.GM.byName.acoustic_grand_piano.number),altspace.inClient){var e=[a.getUser(),a.getSpace(),a.getEnclosure()];Promise.all(e).then(function(e){var o=e.shift();w=o?o.displayName+"-"+Math.random().toString(36).substr(2,9):"altspaceUser-"+Math.random().toString(36).substr(2,9),y=Please.make_color({golden:!1,saturation:1,value:1})[0],I=new THREE.Color(y);var i=e.shift();B=i.sid,x=i.name;var n=e.shift();F=1==n.innerDepth?n.pixelsPerMeter/285.714294*3:n.pixelsPerMeter/285.714294*3,S=S*F/3,k=k*F/3,D=D*F/3,W=79*F,C=C*F/3,N=1.5*F,console.log("Connecting to Firebase....");var r={appId:"Midi Piano",instanceId:B,authorId:"NorybiaK",baseRefUrl:"midi-piano.firebaseio.com"};a.utilities.sync.connect(r).then(function(e){altspace.getThreeJSTrackingSkeleton().then(function(a){m=a,M.add(m),console.log("Connected to Firebase!"),g=e.instance.child("data"),T=e.instance.child("users"),g.child("name").set(x),console.log("Initalizing Piano...."),t()})})})}}}):void console.log("MidiPiano must be passed a scene! Exiting...")},e.update=function(){TWEEN.update()},window.AFRAME&&AFRAME.registerComponent("midi-piano",{schema:{position:{type:"vec3",default:"0 0 0"},rotation:{type:"vec3",default:"0 0 0"}},init:function(){e.start(this.el.object3D,this.data)},tick:function(){isInitilized&&e.update()}})}(MidiPiano,altspace);
