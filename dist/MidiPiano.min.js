var MidiPiano=MidiPiano||{};!function(e,t){"use strict";function a(){MIDI.programChange(4,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(3,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(2,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(1,MIDI.GM.byName.acoustic_grand_piano.number)}function o(e){P=e?e.displayName+"-"+Math.random().toString(36).substr(2,9):"altspaceUser-"+Math.random().toString(36).substr(2,9),D=Please.make_color({golden:!1,saturation:1,value:1})[0],W=new THREE.Color(D)}function n(e){O=1==e.innerDepth?e.pixelsPerMeter/285.714294*3:e.pixelsPerMeter/285.714294*3,K=K*O/3,V=V*O/3,A=A*O/3,U=79*O,j=j*O/3,J=1.5*O}function i(e,t){t&&(y=t,_.add(y)),console.log("Connected to Firebase!"),B=e.instance.child("data"),b=e.instance.child("users"),B.child("name").set(S),console.log("Initalizing Piano...."),c()}function r(e){var r=[t.getUser(),t.getEnclosure()];Promise.all(r).then(function(t){var r=t.shift();o(r);var s=t.shift();n(s),l(function(){a(),N?i(e):altspace.getThreeJSTrackingSkeleton().then(function(t){i(e,t)})})})}function s(e){altspace.inClient&&(e?r(e):t.getSpace().then(function(e){k=e.sid,S=e.name,console.log("Connecting to Firebase....");var a={appId:"Midi Piano",instanceId:k,authorId:"NorybiaK",baseRefUrl:"midi-piano.firebaseio.com"};t.utilities.sync.connect(a).then(function(e){location.search&&r(e)})}))}function l(e){MIDI.loadPlugin({soundfontUrl:"assets/soundfont/",targetFormat:"ogg",instruments:"acoustic_grand_piano",onsuccess:e})}function c(){for(var e=0;e<7;++e){var t=12*e;d(t+0,"W","B"),d(t+1,"B","W"),d(t+2,"W","B"),d(t+3,"W","W"),d(t+4,"B","W"),d(t+5,"W","B"),d(t+6,"B","W"),d(t+7,"W","B"),d(t+8,"W","W"),d(t+9,"B","W"),d(t+10,"W","B"),d(t+11,"B","W")}d(84,"W","B"),d(85,"B","W"),d(86,"W","B"),d(87,"W","W"),MIDI.Player.addListener(function(e){var t=(e.channel,e.velocity),a=(e.message,e.note-21);144==e.message?0==t?"B"==F[a]?C[a].material.color=L:C[a].material.color=G:C[a].material.color=z:"B"==F[a]?C[a].material.color=L:C[a].material.color=G,C[a].material.needsUpdate=!0}),UltimateLoader.load("assets/model/piano.obj",function(t){R=t,R.scale.set(O,O,O),X.add(R),X.position.set(H.x,H.y,H.z),X.rotation.x=H.x*(Math.PI/180),X.rotation.y=H.y*(Math.PI/180),X.rotation.z=H.z*(Math.PI/180),_.add(X);var a=p("Play me!",0,125,67,-18,50);R.add(a);var o=p("MIDI Keyboard?",0,118,69,-18,50);R.add(o);var n=p("Visit - norybiak.com/apps/piano -",0,114,70,-18,50);R.add(n);var i=new THREE.MTLLoader.MaterialCreator;i.crossOrigin="anonymous";var r="assets/textures/wood.jpg",s=i.loadTexture(r),l=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:s}),c=new THREE.BoxGeometry(7,5,30),d=new THREE.Mesh(c,l);d.scale.set(1,1,1),d.position.set(-75.9,79.5,83),R.add(d);var f=new THREE.Mesh(c,l);for(f.scale.set(1,1,1),f.position.set(77.3,79.5,83),R.add(f),u(),e=0;e<ie.length;e++)ie[e].text=p(ie[e].title,0,100,80.5,0,50),R.add(ie[e].text),ie[e].text.visible=!1;m(),console.log("Piano initalized!");var v=document.querySelector(".piano-loading");v&&(v.style.display="none")})}function d(e,t,a){function o(e){return function(){Q||(v(e+21,127),b.child(P).child("notes").child(e+21).set([Math.random(),127]),setTimeout(function(){h(e+21,0),b.child(P).child("notes").child(e+21).set([0,127])},300))}}if("W"==t){A+="W"==a?K:V,I||(I=new THREE.BoxGeometry(2.68,5.83,17.5),I.name="whiteKeyGeometry",I.translate(0,0,8.75));var n=new THREE.MTLLoader.MaterialCreator;n.crossOrigin="anonymous";var i="assets/textures/keyShadow.png",r=n.loadTexture(i),s=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:r});C[e]=new THREE.Mesh(I,s),C[e].scale.set(O,O,O),C[e].position.set(A,U,j)}else if("B"==t){A+=V,w||(w=new THREE.BoxGeometry(1.52,6.07,12.83),w.name="blackKeyGeometry",w.translate(0,0,6.415));var s=new THREE.MeshBasicMaterial({color:"#000000"});C[e]=new THREE.Mesh(w,s),C[e].scale.set(O,O,O),C[e].position.set(A,U+J,j)}F[e]=t,N||(C[e].addBehavior(altspace.utilities.behaviors.JointCollisionEvents({joints:[["Index","Right",3],["Index","Left",3]],jointCubeSize:.1})),C[e].addEventListener("jointcollisionenter",o(e))),C[e].addEventListener("cursordown",o(e)),X.add(C[e])}function u(){var e=new THREE.MTLLoader.MaterialCreator;e.crossOrigin="anonymous";var t="assets/textures/buttonShadow.png",a=e.loadTexture(t),o=new THREE.BoxGeometry(3,3,3);o.name="buttonGeometry";var n=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#00ff00",map:a}));n.scale.set(1,1,1),n.position.set(0,5,0),Z.add(n),n.addEventListener("cursordown",function(e){MIDI.Player.playing||(B.update({startTime:Firebase.ServerValue.TIMESTAMP}),B.update({userStarted:P}),B.update({playing:1}))});var i=p("Play",5,-1.5,.5,0,25);i.x=5,n.add(i);var r=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#f0ff00",map:a}));r.scale.set(1,1,1),r.position.set(0,0,0),Z.add(r),r.addEventListener("cursorup",function(e){oe++,B.update({playing:0,song:oe})});var s=p("Next",5,-1.5,.5,0,25);r.add(s);var l=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#FF0000",map:a}));l.scale.set(1,1,1),l.position.set(0,-5,0),Z.add(l),l.addEventListener("cursorup",function(e){B.update({playing:0})});var c=p("Stop",5,-1.5,.5,0,25);l.add(c),Z.position.set(-66,95,80),R.add(Z);var d=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#f0ff00",map:a}));d.scale.set(1,1,1),d.position.set(-70,0,0),Y.add(d);var u=p("Mute",0,3,.5,0,25),f=p("Unmute",0,3,.5,0,25);f.visible=!1,d.add(u),d.add(f),d.addEventListener("cursorup",function(e){u.visible=!u.visible,f.visible=!f.visible,Q=!Q,E(Q?0:$)});var m=new THREE.Group;m.position.set(-55,-1,0),Y.add(m);var v=p("Vol",0,-4.5,.5,0,25);m.add(v);for(var h=new THREE.BoxGeometry(.8,1,2),M=0;M<5;M++)q[M]=new THREE.Mesh(h,new THREE.MeshBasicMaterial({color:"#f0ff00",map:a})),q[M].scale.set(2,2*M+2,2),q[M].position.set(-4.2+2*M,-.5+(M+1),-.5),m.add(q[M]),q[M].addEventListener("cursorup",function(e){for(var t=!1,a=0;a<5;a++)e.target==q[a]?(q[a].material.color=te,$=a+1,E($),t=!0):t?q[a].material.color=ee:q[a].material.color=te});Y.position.set(120,95,80),Y.scale.set(1,1,1),R.add(Y)}function p(e,t,a,o,n,i){var r={text:e,fontSize:i},s=M(r);return s.position.set(t,a,o+1),s.rotateX(n*Math.PI/180),s}function f(e,t){e.visible=t}function m(){function e(){t.on("value",function(e){var t=e.val();1==t?(b.child(P).child("control").update({joinTime:Firebase.ServerValue.TIMESTAMP}),B.child("startTime").once("value",function(e){var t=e.val();b.child(P).child("control").child("joinTime").once("value",function(e){var a=e.val(),o=a-t;o>MIDI.Player.endTime?B.update({playing:0}):(MIDI.Player.currentTime=o,MIDI.Player.start())})})):(MIDI.Player.stop(),B.update({startTime:0}))})}B.once("value",function(e){var t=e.exists();t||B.set({playing:0,song:0})}),b.child(P).child("settings").set({color:D}),b.on("child_added",function(e,t){var a=e.key(),o=b.child(a);a!=P&&(console.log("New user joined: "+a),o.child("settings").child("color").once("value",function(e){var t=e.val();t||(t=Please.make_color({golden:!1,saturation:1,value:1})[0]),ae[a]=new THREE.Color(t),console.log("User "+a+"'s color is set to "+e.val())}),o.child("notes").on("child_added",function(e){var t=e.key();e.val();o.child("notes").child(t).on("value",function(e){var o=e.val();if(o){var n=o[0],i=o[1];0==n?h(t,i):v(t,i,a)}})}))}),b.child(P).onDisconnect().remove(),b.on("child_removed",function(e){var t=e.key(),a=b.child(t);a.child("on").off("value"),a.child("off").off("value"),delete ae[t],console.log("User "+e.key()+" has left.")});var t=B.child("playing"),a=B.child("song");B.child("currentTime");a.on("value",function(t){var a=t.val();oe=a>ie.length-1?0:a,ne?(MIDI.Player.timeWarp=ie[oe].speed,MIDI.Player.loadFile("assets/songs/"+ie[oe].file,function(){console.log(ie[oe].title+"  loaded!"),e(),ne=!1})):(MIDI.Player.timeWarp=ie[oe].speed,MIDI.Player.loadFile("assets/songs/"+ie[oe].file,function(){console.log(ie[oe].title+"  loaded!")})),f(ie[a-1].text,!1),f(ie[oe].text,!0),console.log("current song:"+oe)}),console.log("Firebase functions initalized!")}function v(e,t,a){if(a=a||!1,Q||MIDI.noteOn(0,e,t),0==C[e-21].rotation.x)if("B"==F[e-21]){new TWEEN.Tween(C[e-21].rotation).to({x:C[e-21].rotation.x+.02*Math.PI},.1).start()}else{new TWEEN.Tween(C[e-21].rotation).to({x:C[e-21].rotation.x+.04*Math.PI},.1).start()}a?C[e-21].material.color=ae[a]:C[e-21].material.color=W}function h(e,t,a){Q||MIDI.noteOff(0,e,t);new TWEEN.Tween(C[e-21].rotation).to({x:0},.1).start();"B"==F[e-21]?C[e-21].material.color=L:C[e-21].material.color=G}function E(e){var t=25.4*e;MIDI.setVolume(0,t),console.log(e+" "+t)}function M(e){var t=g("n-text");return T(t,"n-text",e),t}function g(e){var t=new THREE.Mesh(se,le);return _.add(t),altspace.addNativeComponent(t,e),t}function T(e,t,a){var o=re["n-text"];for(var n in a)o[n]=a[n];altspace.updateNativeComponent(e,t,o)}var y,I,w,R,H,x,_,B,b,P,D,W,C=[],F=[],S="",k="",N=/mobile/i.test(navigator.userAgent),z=new THREE.Color(16711680),G=new THREE.Color(16777215),L=new THREE.Color(0),A=-217,U=-270,j=240,O=3,K=8.5,V=4.2,J=3,X=new THREE.Group,q=[],Y=new THREE.Group,Z=new THREE.Group,Q=!1,$=5,ee=new THREE.Color(10461087),te=new THREE.Color(15793920),ae={},oe=0,ne=!0,ie=[{file:"mozart_sonata_2-pianos_375_1_(c)ishenko.mid",title:"Sonata in D major, for two - Mozart",speed:1},{file:"517-Scarlatti.mid",title:"Sonata in D minor, K. 517 - Scarlatti",speed:.5},{file:"HungarianRhapsodyNo10S24410.mid",title:"Hungarian Rhapsody No. 10, S. 244/10",speed:1},{file:"Roslin_Adama.mid",title:"Roslin & Adama - Bear McCreary",speed:1},{file:"ParagonX9_Chaoz_Fantasy.mid",title:"Chaoz Fantasy - ParagonX9",speed:1},{file:"swordland_1.mid",title:"Swordland (SAO) - Yuki Kajiura",speed:1},{file:"9725s_maple_leaf_rag_(nc)smythe.mid",title:"Maple Leaf - Scott Joplin",speed:1},{file:"hes_a_pirate.mid",title:"He's a Pirate - Klaus Badelt",speed:1},{file:"touhou.mid",title:"U.N. Owen Was Her? - ZUN",speed:1},{file:"cruel_angel.mid",title:"Cruel Angel - Neko Oikawa",speed:1},{file:"tchaikovsky_nutcracker_act-1_2_march_(c)yogore.mid",title:"March (Nutcracker) - Tchaikovsky",speed:1},{file:"Hotline_Bling_MIDI_UPDATED_2016.mid",title:"Hotline Bling",speed:1}],re={"n-text":{text:"",fontSize:10,width:80,height:1,horizontalAlign:"middle",verticalAlign:"middle"}};e.start=function(e,t){_=e||!1;var a=t.connection||!1;return H=t.position||{x:0,y:0,z:0},x=t.rotation||{x:0,y:0,z:0},_?void s(a):void console.log("MidiPiano must be passed a scene! Exiting...")},e.update=function(){TWEEN.update(),N||_.updateAllBehaviors()};var se=new THREE.BoxGeometry(.001,.001,.001),le=new THREE.MeshBasicMaterial({color:0});le.visible=!1,window.AFRAME&&AFRAME.registerComponent("midi-piano",{schema:{position:{type:"vec3",default:"0 0 0"},rotation:{type:"vec3",default:"0 0 0"}},init:function(){e.start(this.el.object3D,this.data)},tick:function(){isInitilized&&e.update()}})}(MidiPiano,altspace);
