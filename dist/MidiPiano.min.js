var MidiPiano=MidiPiano||{};!function(e,t){"use strict";function a(){MIDI.programChange(4,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(3,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(2,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(1,MIDI.GM.byName.acoustic_grand_piano.number)}function o(e){P=e?e.displayName+"-"+Math.random().toString(36).substr(2,9):"altspaceUser-"+Math.random().toString(36).substr(2,9),b=Please.make_color({golden:!1,saturation:1,value:1})[0],D=new THREE.Color(b)}function n(e){U=1==e.innerDepth?e.pixelsPerMeter/285.714294*3:e.pixelsPerMeter/285.714294*3,j=j*U/3,O=O*U/3,G=G*U/3,L=79*U,A=A*U/3,K=1.5*U}function i(e){var i=[t.getUser(),t.getEnclosure()];Promise.all(i).then(function(t){var i=t.shift();o(i);var r=t.shift();n(r),s(function(){a(),altspace.getThreeJSTrackingSkeleton().then(function(t){T=t,x.add(T),console.log("Connected to Firebase!"),_=e.instance.child("data"),B=e.instance.child("users"),_.child("name").set(F),console.log("Initalizing Piano...."),l()})})})}function r(){altspace.inClient&&t.getSpace().then(function(e){S=e.sid,F=e.name,console.log("Connecting to Firebase....");var a={appId:"Midi Piano",instanceId:S,authorId:"NorybiaK",baseRefUrl:"midi-piano.firebaseio.com"};t.utilities.sync.connect(a).then(function(e){location.search&&i(e)})})}function s(e){MIDI.loadPlugin({soundfontUrl:"assets/soundfont/",targetFormat:"ogg",instruments:"acoustic_grand_piano",onsuccess:e})}function l(){for(var e=0;e<7;++e){var t=12*e;d(t+0,"W","B"),d(t+1,"B","W"),d(t+2,"W","B"),d(t+3,"W","W"),d(t+4,"B","W"),d(t+5,"W","B"),d(t+6,"B","W"),d(t+7,"W","B"),d(t+8,"W","W"),d(t+9,"B","W"),d(t+10,"W","B"),d(t+11,"B","W")}d(84,"W","B"),d(85,"B","W"),d(86,"W","B"),d(87,"W","W"),MIDI.Player.addListener(function(e){var t=(e.channel,e.velocity),a=(e.message,e.note-21);144==e.message?0==t?"B"==C[a]?W[a].material.color=z:W[a].material.color=N:W[a].material.color=k:"B"==C[a]?W[a].material.color=z:W[a].material.color=N,W[a].material.needsUpdate=!0}),UltimateLoader.load("assets/model/piano.obj",function(t){w=t,w.scale.set(U,U,U),V.add(w),V.position.set(R.x,R.y,R.z),V.rotation.x=R.x*(Math.PI/180),V.rotation.y=R.y*(Math.PI/180),V.rotation.z=R.z*(Math.PI/180),x.add(V);var a=u("Play me!",0,125,67,-18,50);w.add(a);var o=u("MIDI Keyboard?",0,118,69,-18,50);w.add(o);var n=u("Visit - norybiak.com/apps/piano -",0,114,70,-18,50);w.add(n);var i=new THREE.MTLLoader.MaterialCreator;i.crossOrigin="anonymous";var r="assets/textures/wood.jpg",s=i.loadTexture(r),l=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:s}),d=new THREE.BoxGeometry(7,5,30),p=new THREE.Mesh(d,l);p.scale.set(1,1,1),p.position.set(-75.9,79.5,83),w.add(p);var f=new THREE.Mesh(d,l);for(f.scale.set(1,1,1),f.position.set(77.3,79.5,83),w.add(f),c(),e=0;e<oe.length;e++)oe[e].text=u(oe[e].title,0,100,80.5,0,50),w.add(oe[e].text),oe[e].text.visible=!1;animate(),m(),console.log("Piano initalized!")})}function d(e,t,a){if("W"==t){G+="W"==a?j:O,y||(y=new THREE.BoxGeometry(2.68,5.83,17.5),y.name="whiteKeyGeometry",y.translate(0,0,8.75));var o=new THREE.MTLLoader.MaterialCreator;o.crossOrigin="anonymous";var n="assets/textures/keyShadow.png",i=o.loadTexture(n),r=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:i});W[e]=new THREE.Mesh(y,r),W[e].scale.set(U,U,U),W[e].position.set(G,L,A)}else if("B"==t){G+=O,I||(I=new THREE.BoxGeometry(1.52,6.07,12.83),I.name="blackKeyGeometry",I.translate(0,0,6.415));var r=new THREE.MeshBasicMaterial({color:"#000000"});W[e]=new THREE.Mesh(I,r),W[e].scale.set(U,U,U),W[e].position.set(G,L+K,A)}C[e]=t,W[e].addBehavior(altspace.utilities.behaviors.JointCollisionEvents({joints:[["Index","Right",3],["Index","Left",3]],jointCubeSize:.1})),W[e].addEventListener("jointcollisionenter",function(t){Z||(f(e+21,127),B.child(P).child("notes").child(e+21).set([Math.random(),127]),setTimeout(function(){h(e+21,0),B.child(P).child("notes").child(e+21).set([0,127])},300))}),W[e].addEventListener("cursordown",function(){Z||(f(e+21,127),B.child(P).child("notes").child(e+21).set([Math.random(),127]),setTimeout(function(){h(e+21,0),B.child(P).child("notes").child(e+21).set([0,127])},300))}),V.add(W[e])}function c(){var e=new THREE.MTLLoader.MaterialCreator;e.crossOrigin="anonymous";var t="assets/textures/buttonShadow.png",a=e.loadTexture(t),o=new THREE.BoxGeometry(3,3,3);o.name="buttonGeometry";var n=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#00ff00",map:a}));n.scale.set(1,1,1),n.position.set(0,5,0),Y.add(n),n.addEventListener("cursordown",function(e){MIDI.Player.playing||(_.update({startTime:Firebase.ServerValue.TIMESTAMP}),_.update({userStarted:P}),_.update({playing:1}))});var i=u("Play",5,-1.5,.5,0,25);i.x=5,n.add(i);var r=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#f0ff00",map:a}));r.scale.set(1,1,1),r.position.set(0,0,0),Y.add(r),r.addEventListener("cursorup",function(e){te++,_.update({playing:0,song:te})});var s=u("Next",5,-1.5,.5,0,25);r.add(s);var l=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#FF0000",map:a}));l.scale.set(1,1,1),l.position.set(0,-5,0),Y.add(l),l.addEventListener("cursorup",function(e){_.update({playing:0})});var d=u("Stop",5,-1.5,.5,0,25);l.add(d),Y.position.set(-66,95,80),w.add(Y);var c=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#f0ff00",map:a}));c.scale.set(1,1,1),c.position.set(-70,0,0),X.add(c);var p=u("Mute",0,3,.5,0,25),m=u("Unmute",0,3,.5,0,25);m.visible=!1,c.add(p),c.add(m),c.addEventListener("cursorup",function(e){p.visible=!p.visible,m.visible=!m.visible,Z=!Z,v(Z?0:q)});var f=new THREE.Group;f.position.set(-55,-1,0),X.add(f);var h=u("Vol",0,-4.5,.5,0,25);f.add(h);for(var E=new THREE.BoxGeometry(.8,1,2),M=0;M<5;M++)J[M]=new THREE.Mesh(E,new THREE.MeshBasicMaterial({color:"#f0ff00",map:a})),J[M].scale.set(2,2*M+2,2),J[M].position.set(-4.2+2*M,-.5+(M+1),-.5),f.add(J[M]),J[M].addEventListener("cursorup",function(e){for(var t=!1,a=0;a<5;a++)e.target==J[a]?(J[a].material.color=$,q=a+1,v(q),t=!0):t?J[a].material.color=Q:J[a].material.color=$});X.position.set(120,95,80),X.scale.set(1,1,1),w.add(X)}function u(e,t,a,o,n,i){var r={text:e,fontSize:i},s=E(r);return s.position.set(t,a,o+1),s.rotateX(n*Math.PI/180),s}function p(e,t){e.visible=t}function m(){function e(){t.on("value",function(e){var t=e.val();1==t?(B.child(P).child("control").update({joinTime:Firebase.ServerValue.TIMESTAMP}),_.child("startTime").once("value",function(e){var t=e.val();B.child(P).child("control").child("joinTime").once("value",function(e){var a=e.val(),o=a-t;o>MIDI.Player.endTime?_.update({playing:0}):(MIDI.Player.currentTime=o,MIDI.Player.start())})})):(MIDI.Player.stop(),_.update({startTime:0}))})}_.once("value",function(e){var t=e.exists();t||_.set({playing:0,song:0})}),B.child(P).child("settings").set({color:b}),B.on("child_added",function(e,t){var a=e.key(),o=B.child(a);a!=P&&(console.log("New user joined: "+a),o.child("settings").child("color").once("value",function(e){var t=e.val();t||(t=Please.make_color({golden:!1,saturation:1,value:1})[0]),ee[a]=new THREE.Color(t),console.log("User "+a+"'s color is set to "+e.val())}),o.child("notes").on("child_added",function(e){var t=e.key();e.val();o.child("notes").child(t).on("value",function(e){var o=e.val();if(o){var n=o[0],i=o[1];0==n?h(t,i):f(t,i,a)}})}))}),B.child(P).onDisconnect().remove(),B.on("child_removed",function(e){var t=e.key(),a=B.child(t);a.child("on").off("value"),a.child("off").off("value"),delete ee[t],console.log("User "+e.key()+" has left.")});var t=_.child("playing"),a=_.child("song");_.child("currentTime");a.on("value",function(t){var a=t.val();te=a>oe.length-1?0:a,ae?(MIDI.Player.timeWarp=oe[te].speed,MIDI.Player.loadFile("assets/songs/"+oe[te].file,function(){console.log(oe[te].title+"  loaded!"),e(),ae=!1})):(MIDI.Player.timeWarp=oe[te].speed,MIDI.Player.loadFile("assets/songs/"+oe[te].file,function(){console.log(oe[te].title+"  loaded!")})),p(oe[a-1].text,!1),p(oe[te].text,!0),console.log("current song:"+te)}),console.log("Firebase functions initalized!")}function f(e,t,a){if(a=a||!1,Z||MIDI.noteOn(0,e,t),0==W[e-21].rotation.x)if("B"==C[e-21]){new TWEEN.Tween(W[e-21].rotation).to({x:W[e-21].rotation.x+.02*Math.PI},.1).start()}else{new TWEEN.Tween(W[e-21].rotation).to({x:W[e-21].rotation.x+.04*Math.PI},.1).start()}a?W[e-21].material.color=ee[a]:W[e-21].material.color=D}function h(e,t,a){Z||MIDI.noteOff(0,e,t);new TWEEN.Tween(W[e-21].rotation).to({x:0},.1).start();"B"==C[e-21]?W[e-21].material.color=z:W[e-21].material.color=N}function v(e){var t=25.4*e;MIDI.setVolume(0,t),console.log(e+" "+t)}function E(e){var t=M("n-text");return g(t,"n-text",e),t}function M(e){var t=new THREE.Mesh(ie,re);return x.add(t),altspace.addNativeComponent(t,e),t}function g(e,t,a){var o=ne["n-text"];for(var n in a)o[n]=a[n];altspace.updateNativeComponent(e,t,o)}var T,y,I,w,R,H,x,_,B,P,b,D,W=[],C=[],F="",S="",k=new THREE.Color(16711680),N=new THREE.Color(16777215),z=new THREE.Color(0),G=-217,L=-270,A=240,U=3,j=8.5,O=4.2,K=3,V=new THREE.Group,J=[],X=new THREE.Group,Y=new THREE.Group,Z=!1,q=5,Q=new THREE.Color(10461087),$=new THREE.Color(15793920),ee={},te=0,ae=!0,oe=[{file:"mozart_sonata_2-pianos_375_1_(c)ishenko.mid",title:"Sonata in D major, for two - Mozart",speed:1},{file:"517-Scarlatti.mid",title:"Sonata in D minor, K. 517 - Scarlatti",speed:.5},{file:"HungarianRhapsodyNo10S24410.mid",title:"Hungarian Rhapsody No. 10, S. 244/10",speed:1},{file:"Roslin_Adama.mid",title:"Roslin & Adama - Bear McCreary",speed:1},{file:"ParagonX9_Chaoz_Fantasy.mid",title:"Chaoz Fantasy - ParagonX9",speed:1},{file:"swordland_1.mid",title:"Swordland (SAO) - Yuki Kajiura",speed:1},{file:"9725s_maple_leaf_rag_(nc)smythe.mid",title:"Maple Leaf - Scott Joplin",speed:1},{file:"hes_a_pirate.mid",title:"He's a Pirate - Klaus Badelt",speed:1},{file:"touhou.mid",title:"U.N. Owen Was Her? - ZUN",speed:1},{file:"cruel_angel.mid",title:"Cruel Angel - Neko Oikawa",speed:1},{file:"tchaikovsky_nutcracker_act-1_2_march_(c)yogore.mid",title:"March (Nutcracker) - Tchaikovsky",speed:1},{file:"Hotline_Bling_MIDI_UPDATED_2016.mid",title:"Hotline Bling",speed:1}],ne={"n-text":{text:"",fontSize:10,width:80,height:1,horizontalAlign:"middle",verticalAlign:"middle"}};e.start=function(e,t){return x=e||!1,R=t.position||{x:0,y:0,z:0},H=t.rotation||{x:0,y:0,z:0},x?void r():void console.log("MidiPiano must be passed a scene! Exiting...")},e.update=function(){TWEEN.update()};var ie=new THREE.BoxGeometry(.001,.001,.001),re=new THREE.MeshBasicMaterial({color:0});re.visible=!1,window.AFRAME&&AFRAME.registerComponent("midi-piano",{schema:{position:{type:"vec3",default:"0 0 0"},rotation:{type:"vec3",default:"0 0 0"}},init:function(){e.start(this.el.object3D,this.data)},tick:function(){isInitilized&&e.update()}})}(MidiPiano,altspace);
