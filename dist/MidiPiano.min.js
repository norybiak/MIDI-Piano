var MidiPiano=MidiPiano||{};!function(e,t){"use strict";function a(){MIDI.programChange(4,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(3,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(2,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(1,MIDI.GM.byName.acoustic_grand_piano.number)}function o(e){B=e?e.displayName+"-"+Math.random().toString(36).substr(2,9):"altspaceUser-"+Math.random().toString(36).substr(2,9),_=Please.make_color({golden:!1,saturation:1,value:1})[0],P=new THREE.Color(_)}function n(e){L=1==e.innerDepth?e.pixelsPerMeter/285.714294*3:e.pixelsPerMeter/285.714294*3,A=A*L/3,U=U*L/3,N=N*L/3,z=79*L,G=G*L/3,j=1.5*L}function i(e){var i=[t.getUser(),t.getEnclosure()];Promise.all(i).then(function(t){var i=t.shift();o(i);var r=t.shift();n(r),s(function(){a(),altspace.getThreeJSTrackingSkeleton().then(function(t){T=t,R.add(T),console.log("Connected to Firebase!"),H=e.instance.child("data"),x=e.instance.child("users"),H.child("name").set(W),console.log("Initalizing Piano...."),l()})})})}function r(){altspace.inClient&&t.getSpace().then(function(e){C=e.sid,W=e.name,console.log("Connecting to Firebase....");var a={appId:"Midi Piano",instanceId:C,authorId:"NorybiaK",baseRefUrl:"midi-piano.firebaseio.com"};t.utilities.sync.connect(a).then(function(e){location.search&&i(e)})})}function s(e){MIDI.loadPlugin({soundfontUrl:"assets/soundfont/",targetFormat:"ogg",instruments:"acoustic_grand_piano",onsuccess:e})}function l(){for(var e=0;e<7;++e){var t=12*e;c(t+0,"W","B"),c(t+1,"B","W"),c(t+2,"W","B"),c(t+3,"W","W"),c(t+4,"B","W"),c(t+5,"W","B"),c(t+6,"B","W"),c(t+7,"W","B"),c(t+8,"W","W"),c(t+9,"B","W"),c(t+10,"W","B"),c(t+11,"B","W")}c(84,"W","B"),c(85,"B","W"),c(86,"W","B"),c(87,"W","W"),MIDI.Player.addListener(function(e){var t=(e.channel,e.velocity),a=(e.message,e.note-21);144==e.message?0==t?"B"==D[a]?b[a].material.color=k:b[a].material.color=S:b[a].material.color=F:"B"==D[a]?b[a].material.color=k:b[a].material.color=S,b[a].material.needsUpdate=!0}),UltimateLoader.load("assets/model/piano.obj",function(t){y=t,y.scale.set(L,L,L),O.add(y),O.position.set(w.x,w.y,w.z),O.rotation.x=w.x*(Math.PI/180),O.rotation.y=w.y*(Math.PI/180),O.rotation.z=w.z*(Math.PI/180),R.add(O);var a=u("Play me!",0,125,67,-18,50);y.add(a);var o=u("MIDI Keyboard?",0,118,69,-18,50);y.add(o);var n=u("Visit - norybiak.com/apps/piano -",0,114,70,-18,50);y.add(n);var i=new THREE.MTLLoader.MaterialCreator;i.crossOrigin="anonymous";var r="assets/textures/wood.jpg",s=i.loadTexture(r),l=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:s}),c=new THREE.BoxGeometry(7,5,30),p=new THREE.Mesh(c,l);p.scale.set(1,1,1),p.position.set(-75.9,79.5,83),y.add(p);var h=new THREE.Mesh(c,l);for(h.scale.set(1,1,1),h.position.set(77.3,79.5,83),y.add(h),d(),e=0;e<te.length;e++)te[e].text=u(te[e].title,0,100,80.5,0,50),y.add(te[e].text),te[e].text.visible=!1;animate(),f(),console.log("Piano initalized!");var m=document.querySelector(".piano-loading");m&&(m.style.display="none")})}function c(e,t,a){if("W"==t){N+="W"==a?A:U;var o=new THREE.BoxGeometry(2.68,5.83,17.5);o.translate(0,0,8.75);var n=new THREE.MTLLoader.MaterialCreator;n.crossOrigin="anonymous";var i="assets/textures/keyShadow.png",r=n.loadTexture(i),s=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:r});b[e]=new THREE.Mesh(o,s),b[e].scale.set(L,L,L),b[e].position.set(N,z,G)}else if("B"==t){N+=U;var o=new THREE.BoxGeometry(1.52,6.07,12.83),s=new THREE.MeshBasicMaterial({color:"#000000"});o.translate(0,0,6.415),b[e]=new THREE.Mesh(o,s),b[e].scale.set(L,L,L),b[e].position.set(N,z+j,G)}D[e]=t,b[e].addBehavior(altspace.utilities.behaviors.JointCollisionEvents({joints:[["Index","Right",3],["Index","Left",3]],jointCubeSize:.1})),b[e].addEventListener("jointcollisionenter",function(t){X||(h(e+21,127),x.child(B).child("notes").child(e+21).set([Math.random(),127]),setTimeout(function(){m(e+21,0),x.child(B).child("notes").child(e+21).set([0,127])},300))}),b[e].addEventListener("cursordown",function(){X||(h(e+21,127),x.child(B).child("notes").child(e+21).set([Math.random(),127]),setTimeout(function(){m(e+21,0),x.child(B).child("notes").child(e+21).set([0,127])},300))}),O.add(b[e])}function d(){var e,t=new THREE.MTLLoader.MaterialCreator;t.crossOrigin="anonymous";var a="assets/textures/buttonShadow.png",o=t.loadTexture(a);e=new THREE.BoxGeometry(3,3,3);var n=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#00ff00",map:o}));n.scale.set(1,1,1),n.position.set(0,5,0),J.add(n),n.addEventListener("cursordown",function(e){MIDI.Player.playing||(H.update({startTime:Firebase.ServerValue.TIMESTAMP}),H.update({userStarted:B}),H.update({playing:1}))});var i=u("Play",5,-1.5,.5,0,25);i.x=5,n.add(i),e=new THREE.BoxGeometry(3,3,3);var r=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#f0ff00",map:o}));r.scale.set(1,1,1),r.position.set(0,0,0),J.add(r),r.addEventListener("cursorup",function(e){$++,H.update({playing:0,song:$})});var s=u("Next",5,-1.5,.5,0,25);r.add(s),e=new THREE.BoxGeometry(3,3,3);var l=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#FF0000",map:o}));l.scale.set(1,1,1),l.position.set(0,-5,0),J.add(l),l.addEventListener("cursorup",function(e){H.update({playing:0})});var c=u("Stop",5,-1.5,.5,0,25);l.add(c),J.position.set(-66,95,80),y.add(J),e=new THREE.BoxGeometry(3,3,3);var d=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#f0ff00",map:o}));d.scale.set(1,1,1),d.position.set(-70,0,0),V.add(d);var p=u("Mute",0,3,.5,0,25),f=u("Unmute",0,3,.5,0,25);f.visible=!1,d.add(p),d.add(f),d.addEventListener("cursorup",function(e){p.visible=!p.visible,f.visible=!f.visible,X=!X,E(X?0:q)}),e=new THREE.BoxGeometry(10,1,0);var h=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#9f9f9f",map:o}));h.scale.set(1,1,1),h.position.set(-55,-1,0),h.visible=!1,V.add(h);var m=u("Vol",0,-4.5,.5,0,25);h.add(m);for(var v=0;v<5;v++)e=new THREE.BoxGeometry(.8,v+1,2),K[v]=new THREE.Mesh(e,new THREE.MeshBasicMaterial({color:"#f0ff00",map:o})),K[v].scale.set(2,2,2),K[v].position.set(-4.2+2*v,-.5+(v+1),-.5),h.add(K[v]),K[v].addEventListener("cursorup",function(e){for(var t=!1,a=0;a<5;a++)e.target==K[a]?(K[a].material.color=Z,q=a+1,E(q),t=!0):t?K[a].material.color=Y:K[a].material.color=Z});V.position.set(120,95,80),V.scale.set(1,1,1),y.add(V)}function u(e,t,a,o,n,i){var r={text:e,fontSize:i},s=v(r);return s.position.set(t,a,o+1),s.rotateX(n*Math.PI/180),s}function p(e,t){e.visible=t}function f(){function e(){t.on("value",function(e){var t=e.val();1==t?(x.child(B).child("control").update({joinTime:Firebase.ServerValue.TIMESTAMP}),H.child("startTime").once("value",function(e){var t=e.val();x.child(B).child("control").child("joinTime").once("value",function(e){var a=e.val(),o=a-t;o>MIDI.Player.endTime?H.update({playing:0}):(MIDI.Player.currentTime=o,MIDI.Player.start())})})):(MIDI.Player.stop(),H.update({startTime:0}))})}H.once("value",function(e){var t=e.exists();t||H.set({playing:0,song:0})}),x.child(B).child("settings").set({color:_}),x.on("child_added",function(e,t){var a=e.key(),o=x.child(a);a!=B&&(console.log("New user joined: "+a),o.child("settings").child("color").once("value",function(e){var t=e.val();t||(t=Please.make_color({golden:!1,saturation:1,value:1})[0]),Q[a]=new THREE.Color(t),console.log("User "+a+"'s color is set to "+e.val())}),o.child("notes").on("child_added",function(e){var t=e.key();e.val();o.child("notes").child(t).on("value",function(e){var o=e.val();if(o){var n=o[0],i=o[1];0==n?m(t,i):h(t,i,a)}})}))}),x.child(B).onDisconnect().remove(),x.on("child_removed",function(e){var t=e.key(),a=x.child(t);a.child("on").off("value"),a.child("off").off("value"),delete Q[t],console.log("User "+e.key()+" has left.")});var t=H.child("playing"),a=H.child("song");H.child("currentTime");a.on("value",function(t){var a=t.val();$=a>te.length-1?0:a,ee?(MIDI.Player.timeWarp=te[$].speed,MIDI.Player.loadFile("assets/songs/"+te[$].file,function(){console.log(te[$].title+"  loaded!"),e(),ee=!1})):(MIDI.Player.timeWarp=te[$].speed,MIDI.Player.loadFile("assets/songs/"+te[$].file,function(){console.log(te[$].title+"  loaded!")})),p(te[a-1].text,!1),p(te[$].text,!0),console.log("current song:"+$)}),console.log("Firebase functions initalized!")}function h(e,t,a){if(a=a||!1,X||MIDI.noteOn(0,e,t),0==b[e-21].rotation.x)if("B"==D[e-21]){new TWEEN.Tween(b[e-21].rotation).to({x:b[e-21].rotation.x+.02*Math.PI},.1).start()}else{new TWEEN.Tween(b[e-21].rotation).to({x:b[e-21].rotation.x+.04*Math.PI},.1).start()}a?b[e-21].material.color=Q[a]:b[e-21].material.color=P}function m(e,t,a){X||MIDI.noteOff(0,e,t);new TWEEN.Tween(b[e-21].rotation).to({x:0},.1).start();"B"==D[e-21]?b[e-21].material.color=k:b[e-21].material.color=S}function E(e){var t=25.4*e;MIDI.setVolume(0,t),console.log(e+" "+t)}function v(e){var t=M("n-text");return g(t,"n-text",e),t}function M(e){var t=new THREE.BoxGeometry(.001,.001,.001),a=new THREE.MeshBasicMaterial({color:0});a.visible=!1;var o=new THREE.Mesh(t,a);return R.add(o),altspace.addNativeComponent(o,e),o}function g(e,t,a){var o=ae["n-text"];for(var n in a)o[n]=a[n];altspace.updateNativeComponent(e,t,o)}var T,y,w,I,R,H,x,B,_,P,b=[],D=[],W="",C="",F=new THREE.Color(16711680),S=new THREE.Color(16777215),k=new THREE.Color(0),N=-217,z=-270,G=240,L=3,A=8.5,U=4.2,j=3,O=new THREE.Group,K=[],V=new THREE.Group,J=new THREE.Group,X=!1,q=5,Y=new THREE.Color(10461087),Z=new THREE.Color(15793920),Q={},$=0,ee=!0,te=[{file:"mozart_sonata_2-pianos_375_1_(c)ishenko.mid",title:"Sonata in D major, for two - Mozart",speed:1},{file:"517-Scarlatti.mid",title:"Sonata in D minor, K. 517 - Scarlatti",speed:.5},{file:"HungarianRhapsodyNo10S24410.mid",title:"Hungarian Rhapsody No. 10, S. 244/10",speed:1},{file:"Roslin_Adama.mid",title:"Roslin & Adama - Bear McCreary",speed:1},{file:"ParagonX9_Chaoz_Fantasy.mid",title:"Chaoz Fantasy - ParagonX9",speed:1},{file:"swordland_1.mid",title:"Swordland (SAO) - Yuki Kajiura",speed:1},{file:"9725s_maple_leaf_rag_(nc)smythe.mid",title:"Maple Leaf - Scott Joplin",speed:1},{file:"hes_a_pirate.mid",title:"He's a Pirate - Klaus Badelt",speed:1},{file:"touhou.mid",title:"U.N. Owen Was Her? - ZUN",speed:1},{file:"cruel_angel.mid",title:"Cruel Angel - Neko Oikawa",speed:1},{file:"tchaikovsky_nutcracker_act-1_2_march_(c)yogore.mid",title:"March (Nutcracker) - Tchaikovsky",speed:1},{file:"Hotline_Bling_MIDI_UPDATED_2016.mid",title:"Hotline Bling",speed:1}],ae={"n-text":{text:"",fontSize:10,width:80,height:1,horizontalAlign:"middle",verticalAlign:"middle"}};e.start=function(e,t){return R=e||!1,w=t.position||{x:0,y:0,z:0},I=t.rotation||{x:0,y:0,z:0},R?void r():void console.log("MidiPiano must be passed a scene! Exiting...")},e.update=function(){TWEEN.update()},window.AFRAME&&AFRAME.registerComponent("midi-piano",{schema:{position:{type:"vec3",default:"0 0 0"},rotation:{type:"vec3",default:"0 0 0"}},init:function(){e.start(this.el.object3D,this.data)},tick:function(){isInitilized&&e.update()}})}(MidiPiano,altspace);
