var MidiPiano=MidiPiano||{};!function(e,a){"use strict";function t(){MIDI.programChange(4,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(3,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(2,MIDI.GM.byName.acoustic_grand_piano.number),MIDI.programChange(1,MIDI.GM.byName.acoustic_grand_piano.number)}function o(e){P=e?e.displayName+"-"+Math.random().toString(36).substr(2,9):"altspaceUser-"+Math.random().toString(36).substr(2,9),D=Please.make_color({golden:!1,saturation:1,value:1})[0],W=new THREE.Color(D)}function n(e){O=1==e.innerDepth?e.pixelsPerMeter/285.714294*3:e.pixelsPerMeter/285.714294*3,K=K*O/3,V=V*O/3,A=A*O/3,U=79*O,j=j*O/3,J=1.5*O}function i(e,a){a&&(y=a,_.add(y)),console.log("Connected to Firebase!"),B=e.instance.child("data"),b=e.instance.child("users"),B.child("name").set(S),console.log("Initalizing Piano...."),c()}function r(e){var r=[a.getUser(),a.getEnclosure()];Promise.all(r).then(function(a){var r=a.shift();o(r);var s=a.shift();n(s),l(function(){t(),N?i(e):altspace.getThreeJSTrackingSkeleton().then(function(a){i(e,a)})})})}function s(e){altspace.inClient&&(e?r(e):a.getSpace().then(function(e){k=e.sid,S=e.name,console.log("Connecting to Firebase....");var t={appId:"Midi Piano",instanceId:k,authorId:"NorybiaK",baseRefUrl:"midi-piano.firebaseio.com"};a.utilities.sync.connect(t).then(function(e){location.search&&r(e)})}))}function l(e){MIDI.loadPlugin({soundfontUrl:"assets/soundfont/",targetFormat:"ogg",instruments:"acoustic_grand_piano",onsuccess:e})}function c(){for(var e=0;e<7;++e){var a=12*e;d(a+0,"W","B"),d(a+1,"B","W"),d(a+2,"W","B"),d(a+3,"W","W"),d(a+4,"B","W"),d(a+5,"W","B"),d(a+6,"B","W"),d(a+7,"W","B"),d(a+8,"W","W"),d(a+9,"B","W"),d(a+10,"W","B"),d(a+11,"B","W")}d(84,"W","B"),d(85,"B","W"),d(86,"W","B"),d(87,"W","W"),MIDI.Player.addListener(function(e){var a=(e.channel,e.velocity),t=(e.message,e.note-21);144==e.message?0==a?"B"==F[t]?C[t].material.color=L:C[t].material.color=G:C[t].material.color=z:"B"==F[t]?C[t].material.color=L:C[t].material.color=G,C[t].material.needsUpdate=!0}),UltimateLoader.load("assets/model/piano.obj",function(a){R=a,R.scale.set(O,O,O),X.add(R),X.position.set(H.x,H.y,H.z),X.rotation.x=H.x*(Math.PI/180),X.rotation.y=H.y*(Math.PI/180),X.rotation.z=H.z*(Math.PI/180),_.add(X);var t=p("Play me!",0,125,67,-18,50);R.add(t);var o=p("MIDI Keyboard?",0,118,69,-18,50);R.add(o);var n=p("Visit - norybiak.com/apps/piano -",0,114,70,-18,50);R.add(n);var i=new THREE.MTLLoader.MaterialCreator;i.crossOrigin="anonymous";var r="assets/textures/wood.jpg",s=i.loadTexture(r),l=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:s}),c=new THREE.BoxGeometry(7,5,30),d=new THREE.Mesh(c,l);d.scale.set(1,1,1),d.position.set(-75.9,79.5,83),R.add(d);var m=new THREE.Mesh(c,l);for(m.scale.set(1,1,1),m.position.set(77.3,79.5,83),R.add(m),u(),e=0;e<ie.length;e++)ie[e].text=p(ie[e].title,0,100,80.5,0,50),R.add(ie[e].text),ie[e].text.visible=!1;animate(),f(),console.log("Piano initalized!");var v=document.querySelector(".piano-loading");v&&(v.style.display="none")})}function d(e,a,t){function o(e){return function(){Q||(v(e+21,127),b.child(P).child("notes").child(e+21).set([Math.random(),127]),setTimeout(function(){h(e+21,0),b.child(P).child("notes").child(e+21).set([0,127])},300))}}if("W"==a){A+="W"==t?K:V,I||(I=new THREE.BoxGeometry(2.68,5.83,17.5),I.name="whiteKeyGeometry",I.translate(0,0,8.75));var n=new THREE.MTLLoader.MaterialCreator;n.crossOrigin="anonymous";var i="assets/textures/keyShadow.png",r=n.loadTexture(i),s=new THREE.MeshBasicMaterial({color:"#FFFFFF",map:r});C[e]=new THREE.Mesh(I,s),C[e].scale.set(O,O,O),C[e].position.set(A,U,j)}else if("B"==a){A+=V,w||(w=new THREE.BoxGeometry(1.52,6.07,12.83),w.name="blackKeyGeometry",w.translate(0,0,6.415));var s=new THREE.MeshBasicMaterial({color:"#000000"});C[e]=new THREE.Mesh(w,s),C[e].scale.set(O,O,O),C[e].position.set(A,U+J,j)}F[e]=a,N||(C[e].addBehavior(altspace.utilities.behaviors.JointCollisionEvents({joints:[["Index","Right",3],["Index","Left",3]],jointCubeSize:.1})),C[e].addEventListener("jointcollisionenter",o(e))),C[e].addEventListener("cursordown",o(e)),X.add(C[e])}function u(){var e=new THREE.MTLLoader.MaterialCreator;e.crossOrigin="anonymous";var a="assets/textures/buttonShadow.png",t=e.loadTexture(a),o=new THREE.BoxGeometry(3,3,3);o.name="buttonGeometry";var n=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#00ff00",map:t}));n.scale.set(1,1,1),n.position.set(0,5,0),Z.add(n),n.addEventListener("cursordown",function(e){MIDI.Player.playing||(B.update({startTime:Firebase.ServerValue.TIMESTAMP}),B.update({userStarted:P}),B.update({playing:1}))});var i=p("Play",5,-1.5,.5,0,25);i.x=5,n.add(i);var r=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#f0ff00",map:t}));r.scale.set(1,1,1),r.position.set(0,0,0),Z.add(r),r.addEventListener("cursorup",function(e){oe++,B.update({playing:0,song:oe})});var s=p("Next",5,-1.5,.5,0,25);r.add(s);var l=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#FF0000",map:t}));l.scale.set(1,1,1),l.position.set(0,-5,0),Z.add(l),l.addEventListener("cursorup",function(e){B.update({playing:0})});var c=p("Stop",5,-1.5,.5,0,25);l.add(c),Z.position.set(-66,95,80),R.add(Z);var d=new THREE.Mesh(o,new THREE.MeshBasicMaterial({color:"#f0ff00",map:t}));d.scale.set(1,1,1),d.position.set(-70,0,0),Y.add(d);var u=p("Mute",0,3,.5,0,25),m=p("Unmute",0,3,.5,0,25);m.visible=!1,d.add(u),d.add(m),d.addEventListener("cursorup",function(e){u.visible=!u.visible,m.visible=!m.visible,Q=!Q,E(Q?0:$)});var f=new THREE.Group;f.position.set(-55,-1,0),Y.add(f);var v=p("Vol",0,-4.5,.5,0,25);f.add(v);for(var h=new THREE.BoxGeometry(.8,1,2),M=0;M<5;M++)q[M]=new THREE.Mesh(h,new THREE.MeshBasicMaterial({color:"#f0ff00",map:t})),q[M].scale.set(2,2*M+2,2),q[M].position.set(-4.2+2*M,-.5+(M+1),-.5),f.add(q[M]),q[M].addEventListener("cursorup",function(e){for(var a=!1,t=0;t<5;t++)e.target==q[t]?(q[t].material.color=ae,$=t+1,E($),a=!0):a?q[t].material.color=ee:q[t].material.color=ae});Y.position.set(120,95,80),Y.scale.set(1,1,1),R.add(Y)}function p(e,a,t,o,n,i){var r={text:e,fontSize:i},s=M(r);return s.position.set(a,t,o+1),s.rotateX(n*Math.PI/180),s}function m(e,a){e.visible=a}function f(){function e(){a.on("value",function(e){var a=e.val();1==a?(b.child(P).child("control").update({joinTime:Firebase.ServerValue.TIMESTAMP}),B.child("startTime").once("value",function(e){var a=e.val();b.child(P).child("control").child("joinTime").once("value",function(e){var t=e.val(),o=t-a;o>MIDI.Player.endTime?B.update({playing:0}):(MIDI.Player.currentTime=o,MIDI.Player.start())})})):(MIDI.Player.stop(),B.update({startTime:0}))})}B.once("value",function(e){var a=e.exists();a||B.set({playing:0,song:0})}),b.child(P).child("settings").set({color:D}),b.on("child_added",function(e,a){var t=e.key(),o=b.child(t);t!=P&&(console.log("New user joined: "+t),o.child("settings").child("color").once("value",function(e){var a=e.val();a||(a=Please.make_color({golden:!1,saturation:1,value:1})[0]),te[t]=new THREE.Color(a),console.log("User "+t+"'s color is set to "+e.val())}),o.child("notes").on("child_added",function(e){var a=e.key();e.val();o.child("notes").child(a).on("value",function(e){var o=e.val();if(o){var n=o[0],i=o[1];0==n?h(a,i):v(a,i,t)}})}))}),b.child(P).onDisconnect().remove(),b.on("child_removed",function(e){var a=e.key(),t=b.child(a);t.child("on").off("value"),t.child("off").off("value"),delete te[a],console.log("User "+e.key()+" has left.")});var a=B.child("playing"),t=B.child("song");B.child("currentTime");t.on("value",function(a){var t=a.val();oe=t>ie.length-1?0:t,ne?(MIDI.Player.timeWarp=ie[oe].speed,MIDI.Player.loadFile("assets/songs/"+ie[oe].file,function(){console.log(ie[oe].title+"  loaded!"),e(),ne=!1})):(MIDI.Player.timeWarp=ie[oe].speed,MIDI.Player.loadFile("assets/songs/"+ie[oe].file,function(){console.log(ie[oe].title+"  loaded!")})),m(ie[t-1].text,!1),m(ie[oe].text,!0),console.log("current song:"+oe)}),console.log("Firebase functions initalized!")}function v(e,a,t){if(t=t||!1,Q||MIDI.noteOn(0,e,a),0==C[e-21].rotation.x)if("B"==F[e-21]){new TWEEN.Tween(C[e-21].rotation).to({x:C[e-21].rotation.x+.02*Math.PI},.1).start()}else{new TWEEN.Tween(C[e-21].rotation).to({x:C[e-21].rotation.x+.04*Math.PI},.1).start()}t?C[e-21].material.color=te[t]:C[e-21].material.color=W}function h(e,a,t){Q||MIDI.noteOff(0,e,a);new TWEEN.Tween(C[e-21].rotation).to({x:0},.1).start();"B"==F[e-21]?C[e-21].material.color=L:C[e-21].material.color=G}function E(e){var a=25.4*e;MIDI.setVolume(0,a),console.log(e+" "+a)}function M(e){var a=g("n-text");return T(a,"n-text",e),a}function g(e){var a=new THREE.Mesh(se,le);return _.add(a),altspace.addNativeComponent(a,e),a}function T(e,a,t){var o=re["n-text"];for(var n in t)o[n]=t[n];altspace.updateNativeComponent(e,a,o)}var y,I,w,R,H,x,_,B,b,P,D,W,C=[],F=[],S="",k="",N=/mobile/i.test(navigator.userAgent),z=new THREE.Color(16711680),G=new THREE.Color(16777215),L=new THREE.Color(0),A=-217,U=-270,j=240,O=3,K=8.5,V=4.2,J=3,X=new THREE.Group,q=[],Y=new THREE.Group,Z=new THREE.Group,Q=!1,$=5,ee=new THREE.Color(10461087),ae=new THREE.Color(15793920),te={},oe=0,ne=!0,ie=[{file:"mozart_sonata_2-pianos_375_1_(c)ishenko.mid",title:"Sonata in D major, for two - Mozart",speed:1},{file:"517-Scarlatti.mid",title:"Sonata in D minor, K. 517 - Scarlatti",speed:.5},{file:"HungarianRhapsodyNo10S24410.mid",title:"Hungarian Rhapsody No. 10, S. 244/10",speed:1},{file:"Roslin_Adama.mid",title:"Roslin & Adama - Bear McCreary",speed:1},{file:"ParagonX9_Chaoz_Fantasy.mid",title:"Chaoz Fantasy - ParagonX9",speed:1},{file:"swordland_1.mid",title:"Swordland (SAO) - Yuki Kajiura",speed:1},{file:"9725s_maple_leaf_rag_(nc)smythe.mid",title:"Maple Leaf - Scott Joplin",speed:1},{file:"hes_a_pirate.mid",title:"He's a Pirate - Klaus Badelt",speed:1},{file:"touhou.mid",title:"U.N. Owen Was Her? - ZUN",speed:1},{file:"cruel_angel.mid",title:"Cruel Angel - Neko Oikawa",speed:1},{file:"tchaikovsky_nutcracker_act-1_2_march_(c)yogore.mid",title:"March (Nutcracker) - Tchaikovsky",speed:1},{file:"Hotline_Bling_MIDI_UPDATED_2016.mid",title:"Hotline Bling",speed:1}],re={"n-text":{text:"",fontSize:10,width:80,height:1,horizontalAlign:"middle",verticalAlign:"middle"}};e.start=function(e,a){_=e||!1;var t=a.connection||!1;return H=a.position||{x:0,y:0,z:0},x=a.rotation||{x:0,y:0,z:0},_?void s(t):void console.log("MidiPiano must be passed a scene! Exiting...")},e.update=function(){TWEEN.update(),N||_.updateAllBehaviors()};var se=new THREE.BoxGeometry(.001,.001,.001),le=new THREE.MeshBasicMaterial({color:0});le.visible=!1,window.AFRAME&&AFRAME.registerComponent("midi-piano",{schema:{position:{type:"vec3",default:"0 0 0"},rotation:{type:"vec3",default:"0 0 0"}},init:function(){e.start(this.el.object3D,this.data)},tick:function(){isInitilized&&e.update()}})}(MidiPiano,altspace);
